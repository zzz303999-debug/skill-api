...
from app.orders.text.extractor import (
    _split_loading_value,
    _split_vessel_voyage,
    extract_order_text,
)
from app.orders.text.mapper import OrderNotReadyError, build_order_data
from app.orders.text.schema import OrderTextExtraction
...
async def test_source_fields_preserve_unsupported_label_and_value():
    from app.orders.text.extractor import parse_source_fields
...
async def test_publish_reports_non_json_response_details(monkeypatch):
    from app.orders.text.client import OrderUpstreamError
